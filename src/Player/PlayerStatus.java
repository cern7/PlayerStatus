...
public class PlayerStatus {
    ...
    private Weapon knife = new Weapon("knife", 0, 10);
    ...
    public String toString() {
        return "PlayerStatus [nickname=" + nickname + ", score=" + score + ", lives=" + lives + ", health=" + String.format("%.0f", health)
                + ", weapon=" + weaponInHand.getName() + ", position=" + String.format("%.2f", positionX) + "X | "
                + String.format("%.2f", positionY) + "Y ]";
    }
